              ...
              <div class="card-body table-responsive p-0">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">Шалтгаан</th>
   ...
   var rows_selected = [];
    ...
    document.getElementById("result").textContent = "Total Number of Items Selected = " + document.querySelectorAll('input[name="foo"]:checked').length;
            ...
            <script type="text/javascript">
                ...
                const deliveryTableUrl = '{{ route('datatable-delivery-report') }}';
                const loadDeliveryDataTable = (status,bus,driver,customer,verified,not_1,not_100) => {
                ...
                loadDeliveryDataTable(status,bus,driver,customer,verified,not_1,not_100);
