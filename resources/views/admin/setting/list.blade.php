                            ...
                            <tbody>
                                ...
                                @foreach ($region as $regions)
                                    <tr>
                                        ...
                                        @if ($regions->type == '1')
                                            <td>Энгийн</td>
                                        @elseif($regions->type == '2')
                                            <td>1-3 хайрцаг</td>
                                        @elseif($regions->type == '3')
                                            <td>3-6 хайрцаг</td>
                                        @elseif($regions->type == '6')
                                            <td>Бөөний 10+</td>
                                        @elseif($regions->type == '4')
                                            <td>6-10 хайрцаг</td>
                                        @else
                                            <td>Татан авалт</td>
                                        @endif
                                        <td>{{ $regions->price }}</td>
                                        <td>{{ $regions->driver }}</td>
                                        <td> <button class="btn btn-warning"> <a
                                                    href="{{ url('/setting/edit/' . $regions->id) }}">Засах</a></button>
                                        </td>
