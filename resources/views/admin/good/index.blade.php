              ...
              {!! Form::open(['url' => 'good/create', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="ware" class="form-control"  placeholder="Агуулах">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Барааны нэр</label>
                    <input type="text" name="goodname" class="form-control"  placeholder="Барааны нэр">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Үнэ</label>
                    <input type="text" name="price" class="form-control"  placeholder="Үнэ">
                  </div>
