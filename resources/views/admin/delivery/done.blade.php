   ...
   var rows_selected = [];
    ...
    document.getElementById("result").textContent = "Total Number of Items Selected = " + document.querySelectorAll('input[name="foo"]:checked').length;
            ...
            <script type="text/javascript">
                ...
                const loadDeliveryDataTable = (status,bus,driver,customer,status_3,status_4,status_5) => {
                ...
                loadDeliveryDataTable(status,bus,driver,customer,status_3,status_4,status_5);
