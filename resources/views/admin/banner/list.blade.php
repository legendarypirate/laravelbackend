...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <button type="button" class="btn btn-info"> <a href="index" style="color:white;">Шинэ banner үүсгэх</a></button> 
...
<tr>
<td>{{$regions->id}}</td>
<td> <img src="/{{$regions->image}}" width=100></td>
    @if(\Auth::user()->hasPermissionTo('бүс_устгах'))
    <td> <button class="btn btn-danger"> <a href="{{url('/banner/delete/'.$regions->id)}}" style="color:white;">Устгах</a></button></td>
    @else
    <td><a href="#">#</a></td>
