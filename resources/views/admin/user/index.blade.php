      ...
      <div class="container-fluid">
        <div class="row">
              ...
              {!! Form::open(['url' => 'user/create', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <a class="flex items-center text-theme-9 add-phone-cart" href="#" style="float:right; margin-top:8px;" >
                                Нэмэх  </a>
                  </div>
                ...
                <div class="col-md-7 ms-auto">
                    <div class="cart-page-header"><h4 class="cart-page-header-title">Утасны жагсаалт</h4></div>
                                ...
                                <div class="order-card__body">
                                    ...
                                    <div class="product-row">
                                        ...
                                        <div class="product-row__content">
                                            <h2 class="product-row__content-title"><div style="width:200px;">{{urldecode($data['item_name'])}}</div>  <div style="display:inline;">тоо: {{ number_format($data['item_quantity']) }}</div>   <div style="display:inline;margin-left:50px;">  Үнэ:  {{ number_format($data['item_price']) }} </div> </h2> 
          ...
          <div class="form-group">
                    ...
                    <a class="flex items-center text-theme-9 add-address-cart" href="#" style="float:right; margin-top:8px;" >
                                Нэмэх  </a>
                  </div>
...
@php $total="0" @endphp
<div class="col-md-7 ms-auto">
<div class="cart-page-header"><h4 class="cart-page-header-title">Хаягийн жагсаалт</h4></div>
<div class="d-flex flex-column gap-3">
